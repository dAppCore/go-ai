...
// ProviderChatRequest is the package-level chat shape used by go-ai routing
...
// attempts. It stays in go-ai because context assembly is product policy, not a
...
// ProviderRouter applies go-ai provider policy over shared inference models.
...
// NewProviderRouterWithOptions creates a fallback router with shared go-ai
